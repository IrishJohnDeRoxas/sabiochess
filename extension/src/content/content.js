  ...
  function createSabioButton(isFloating, onClickHandler, extraClass = '') {
    ...
    sabioBtn.innerHTML = `
      <div class="sabiochess-logo-badge">
        <svg viewBox="0 0 45 45" width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="sabiochess-btn-text">SABIO<span class="sabiochess-text-orange">CHESS</span> REVIEW</span>
    `;
